...
TS drill 3: implement buildUser with typed email.
...
Run: `npm --prefix practice-suite run exercise:skills` — spec file: `practice-suite/exercises/skills/SK-TS-E03-ts-factories.spec.ts`
