...
TS drill 1: implement buildUser with typed email.
...
Run: `npm --prefix practice-suite run exercise:skills` — spec file: `practice-suite/exercises/skills/SK-TS-E01-ts-factories.spec.ts`
