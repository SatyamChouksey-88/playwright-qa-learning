...
Literal unions & as const: TypeScript gives compile-time safety for test code — treat specs and page objects as production code with strict null checks and explicit return types.
...
Explain how literal unions & as const prevents a real test bug.

## Try it

Answer MCQs `SK-TS-Q011` in the Skills hub.
