...
XSS verification (defensive): QA verifies defenses exist — output encoding, CSRF tokens, authorization checks — without exploit tutorials.
...
Answer MCQs `SK-SEC-Q002`, `SK-SEC-Q003` in the Skills hub.
