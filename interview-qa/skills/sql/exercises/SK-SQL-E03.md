...
SQL exercise 3: write query matching expected output.
...
Run: `npm --prefix practice-suite run exercise:skills` — spec file: `practice-suite/exercises/skills/SK-SQL-E03-sql-joins.spec.ts`
