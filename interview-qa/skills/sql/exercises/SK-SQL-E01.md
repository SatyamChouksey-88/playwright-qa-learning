...
SQL exercise 1: write query matching expected output.
...
Run: `npm --prefix practice-suite run exercise:skills` — spec file: `practice-suite/exercises/skills/SK-SQL-E01-sql-joins.spec.ts`
