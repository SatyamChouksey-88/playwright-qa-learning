...
Subqueries vs joins: SQL lets testers verify backend truth — row counts, orphans, duplicates — faster than clicking through UI.
...
Complete exercise `SK-SQL-E05` — run `npm --prefix practice-suite run exercise:skills`.
