...
const STUDY_ITEMS = [
  ...
  { id: 'pyramid-nft', label: 'Pyramid & non-functional' },
  ...
  { id: 'shadow-advanced', label: 'Shadow DOM edge cases' },
  { id: 'clipboard', label: 'Clipboard & copy/paste' },
  { id: 'fixtures', label: 'Fixtures' },
  { id: 'fixtures-advanced', label: 'Worker fixtures & mergeTests' },
  { id: 'parallelism', label: 'Parallelism internals' },
  ...
  { id: 'websocket', label: 'WebSocket & SSE' },
  { id: 'visual', label: 'Visual, ARIA & a11y' },
  { id: 'a11y-wcag', label: 'WCAG & a11y depth' },
  { id: 'security-qa', label: 'Security at QA level' },
  { id: 'performance-cwv', label: 'Performance & CWV' },
  { id: 'coverage-e2e', label: 'E2E code coverage' },
  { id: 'contract-testing', label: 'Contract testing (Pact)' },
  { id: 'grids-mobile', label: 'Cloud grids & mobile' },
  { id: 'db-sql', label: 'DB & SQL for testers' },
  { id: 'metrics-dora', label: 'DORA & quality metrics' },
  { id: 'bdd-awareness', label: 'BDD awareness' },
  { id: 'mutation-stryker', label: 'Mutation testing' },
  { id: 'agents-mcp', label: 'Agents, MCP & CLI' },
  { id: 'currency-2026', label: 'Currency preview 2026' },
  ...
  { id: 'postmortems', label: 'Incident postmortems' },
  { id: 'global-setup-config', label: 'Global setup & env config' },
  { id: 'reporters-blob', label: 'Custom reporters & blob' },
  { id: 'downloads-geo', label: 'Downloads, geo & locale' },
  { id: 'microservices-mq', label: 'Microservices & queues' },
  { id: 'exploratory-process', label: 'Exploratory & process' },
  { id: 'visual-chaos', label: 'Visual tooling & synthetics' },
  { id: 'system-design-lab', label: 'System-design prompts' },
  { id: 'candidate-mistakes', label: 'Common candidate mistakes' },
